...
- Mọi child được ánh xạ đúng một parent.
- Parent được ghép từ text gốc, không tóm tắt bằng LLM.
- Các trường hợp hierarchy không chắc chắn được hiển thị thành warning.
